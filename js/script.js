...
if(monthInput.value === ""||yearInput.value ==="") {
    expiryError.innerText = "Please enter card expiry date"
    monthInput.value === "" ? monthInput.classList.add("input-error") : yearInput.classList.add("input-error")

}
if(cvcInput.value === "") {
    cvcError.innerText = "Please enter cvc"
